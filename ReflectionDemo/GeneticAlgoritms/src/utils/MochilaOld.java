...
public class MochilaOld {
     ...
     */
    public MochilaOld(int pesoMochila){
        ...
        items = new ArrayList<ItemOld>(numItems);
        criaItems();
    }
    
    public MochilaOld(int pesoMochila, ArrayList<ItemOld> Items, boolean penalizacao){
     ...
     */
    public MochilaOld(int pesoMochila, int maxPeso, int maxValor, int numItems){
        items = new ArrayList<ItemOld>(numItems);
        this.pesoMaximo = pesoMochila;
     ...
     */
    public MochilaOld(int pesoMochila, int[] Peso, int[] Valor){
        items = new ArrayList<ItemOld>(Peso.length);
        this.numItems = Peso.length;
        this.pesoMaximo = pesoMochila;
        for (int i = 0; i < numItems; i++) {
            ItemOld itemMochila = new ItemOld();
    ...
    private void criaItems(){
        for (int i = 0; i < getNumItems(); i++) {
            ItemOld itemMochila = new ItemOld(maxPesoItem, maxValorItem);
     ...
     */
    public ArrayList<ItemOld> getItems() {
        return items;
    }
     ...
     */
    public void setItems(ArrayList<ItemOld> items) {
        this.items = items;
