...
//*************************************************************************
//*************************************************************************************************************************
//********************************  TESTAR SE O NÚMERO DE ENTRADA == NÚMERO DE SAIDA ***********************************
        ...
        int ne = p.getSizePopulation();
        int ns = popOUT.getSizePopulation();
        assertTrue(ne == ns);
...
=======
        ...
        individuo = new Integer[]{3, 5, 7, 8, 6, 2, 4, 1, 9};
        ponto_1 = 2;
        ponto_2 = 7;

        Invertion._invertOrderBetweenTwoPointers(ponto_1, individuo, ponto_2);

        //assertArrayEquals(individuo, new Integer[]{3, 5, 1, 4, 2, 6, 8, 7});
        
        
        
        assertArrayEquals(individuo, new Integer[]{3,5,1,4,2,6,8,7,9});
