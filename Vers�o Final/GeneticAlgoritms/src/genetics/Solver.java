...
import genetics.algorithms.functions.FunctionBinarySphere;
import genetics.algorithms.functions.FunctionRealCircle;
import genetics.algorithms.functions.FunctionRealFractalDoubleDip;
import genetics.algorithms.functions.FunctionRealScherfelProblem;
import genetics.algorithms.functions.FunctionRealShiftedAckley;
import genetics.algorithms.functions.FunctionRealShiftedGriewank;
import genetics.algorithms.functions.FunctionRealShiftedRastrigin;
import genetics.algorithms.functions.FunctionRealShiftedRosenbrock;
import genetics.algorithms.functions.FunctionRealShiftedSphere;
...
public class Solver extends GenericSolver {
    ...
    private boolean marteladaParametros = false;
...
//                System.out.println("Tempo utilizado: " + timePassSeconds(__startTime) + "s");
    ...
    public boolean SetSelection(String parms) {
        if (this.marteladaParametros) {
            this.OperatorBlock = false;
            return true;
        }
        if (_operators == null) {
    ...
    public boolean setParameters(String parameters) {
        try {
            ...
            if (tipoIndividuo.contains("OnesMax")) {
            ...
            } else if (tipoIndividuo.contains("FunctionBinarySphere")) {
                this._prototypeIndividual = new FunctionBinarySphere();
                this._operators.add(new operators.selections.Tournament(10, 2));
                this._operators.add(new Invertion(0.03));
                this._operators.add(new Crossover());
                this._operators.add(new Truncation());
                this.marteladaParametros = true;
                this._sizePopulation = 10;
                this._sizeAllelo = 0;
                this._sizeGenotype = 2;
                this._sizeGenome = 1;
            } else if (tipoIndividuo.contains("FunctionRealCircle")) {
                this._prototypeIndividual = new FunctionRealCircle();
                this._operators.add(new SUS(10));
                this._operators.add(new CrossoverAX(0.75));
                this._operators.add(new MutationGaussian(0.25));
                this._operators.add(new Truncation());
                this.marteladaParametros = true;
                this._sizePopulation = 10;
                this._sizeAllelo = 0;
                this._sizeGenotype = 1;
                this._sizeGenome = 1;
                } else if (tipoIndividuo.contains("FunctionRealFractalDoubleDip")) {
                this._prototypeIndividual = new FunctionRealFractalDoubleDip();
                this._operators.add(new SUS(10));
                this._operators.add(new CrossoverAX(0.75));
                this._operators.add(new MutationGaussian(0.25));
                this._operators.add(new Truncation());
                ...
                this._sizeGenotype = 2;
                this._sizeGenome = 1;
                } else if (tipoIndividuo.contains("FunctionRealScherfelProblem")) {
                this._prototypeIndividual = new FunctionRealScherfelProblem();
                this._operators.add(new SUS(10));
                this._operators.add(new CrossoverAX(0.75));
                this._operators.add(new MutationGaussian(0.25));
                this._operators.add(new Truncation());
                ...
                this._sizeGenotype = 2;
                this._sizeGenome = 1;
               } else if (tipoIndividuo.contains("FunctionRealShiftedAckley")) {
                this._prototypeIndividual = new FunctionRealShiftedAckley();
                this._operators.add(new SUS(10));
                this._operators.add(new CrossoverAX(0.75));
                this._operators.add(new MutationGaussian(0.25));
                this._operators.add(new Truncation());
                ...
                this._sizeGenotype = 2;
                this._sizeGenome = 1;
                } else if (tipoIndividuo.contains("FunctionRealShiftedGriewank")) {
                this._prototypeIndividual = new FunctionRealShiftedGriewank();
                this._operators.add(new SUS(10));
                this._operators.add(new CrossoverAX(0.75));
                this._operators.add(new MutationGaussian(0.25));
                this._operators.add(new Truncation());
                ...
                this._sizeGenotype = 2;
                this._sizeGenome = 1;
                } else if (tipoIndividuo.contains("FunctionRealShiftedRastrigin")) {
                this._prototypeIndividual = new FunctionRealShiftedRastrigin();
                this._operators.add(new SUS(10));
                this._operators.add(new CrossoverAX(0.75));
                this._operators.add(new MutationGaussian(0.25));
                this._operators.add(new Truncation());
                ...
                this._sizeGenotype = 2;
                this._sizeGenome = 1;
                } else if (tipoIndividuo.contains("FunctionRealShiftedRosenbrock")) {
                this._prototypeIndividual = new FunctionRealShiftedRosenbrock();
                this._operators.add(new SUS(10));
                this._operators.add(new CrossoverAX(0.75));
                this._operators.add(new MutationGaussian(0.25));
                this._operators.add(new Truncation());
                ...
                this._sizeGenotype = 2;
                this._sizeGenome = 1;
                } else if (tipoIndividuo.contains("FunctionRealShiftedSphere")) {
                this._prototypeIndividual = new FunctionRealShiftedSphere();
                this._operators.add(new SUS(10));
                this._operators.add(new CrossoverAX(0.75));
                this._operators.add(new MutationGaussian(0.25));
                this._operators.add(new Truncation());
