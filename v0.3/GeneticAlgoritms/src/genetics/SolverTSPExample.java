...
public class SolverTSPExample {
    ...
    public SolverTSPExample() throws MalformedURLException, IOException{
        ...
        this.operators.add(new SUS(600));
        this.operators.add(new Invertion(0.025));
        operators.add(new Truncation());
        operators.add(new OrderCrossover(0.40));
        //operators.add(new PMX(0.40));
        ...
        solver.SetStopCrit("10000 8000");
        solver.setParameters("600 1 1 280 TSP");
